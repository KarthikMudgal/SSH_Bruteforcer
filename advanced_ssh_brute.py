...
def main():
    ...
    parser.add_argument("-U", "--userlist", help="Usernames list to bruteforce ssh.")
    ...
    parser.add_argument("-c", "--chars", type=str, help="Characters to use for passwords generation.")
